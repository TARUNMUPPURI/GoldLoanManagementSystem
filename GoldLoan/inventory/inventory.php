...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
		...
		if(isset($_POST["weight"]) && !empty($_POST["weight"])) {
			if (preg_match("/^[0-9]*$/", $_POST["weight"])) {
					...
					$sql = "INSERT INTO `goldloan`.`customer`(`firstname`, `lastname`, `mobile`, `email`, `address`, `gender`, `password`, `ornaments`, `weight`, `purity`, `loan`, `interest`, `monthinterest`, `goldrate`, `paidloan`, `remening_loan`)
													 VALUES ('$name','$sname','$phonen','$email','$add','$gender','$pass','$ornaments','$weight','$purity','$loan','$interest','$m_int','$r','$paidloan','$loan');";
